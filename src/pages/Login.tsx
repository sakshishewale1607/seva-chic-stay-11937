...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (!user) {
      toast({
        title: "Login Failed",
        description: "Invalid credentials. Please register if you're a new user.",
        variant: "destructive",
      });
      return;
    }
  ...
  />
            ...
            <div>
              ...
              <p className="text-muted-foreground">Luxury  Booking</p>
            </div>
          </div>
          <img 
            src={heroImage} 
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">Experience Luxury Like Never Before</h2>
            <p className="text-muted-foreground leading-relaxed">
              Book your perfect stay with SevaStay and enjoy world-class hospitality, 
              premium amenities, and unforgettable experiences.
            </p>
          </div>
        </div>
